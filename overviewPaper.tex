...
% Suggest to introduce acronyms as Proper Name of the Thing (PNT)
Of the eight sub-campaigns, this paper summarises PERCUSION (Persistent EarthCARE underflight studies of the ITCZ and organized convection), a campaign utilising the German High Altitude and Long Range Research Aircraft (HALO). Configured as a cloud observatory, HALO's high-altitude and long-range capabilities allow it to provide ``snapshots" of the mesoscale structure of the circulation and thermodynamic state of the ITCZ \citep{stevensHighAltitudeLongRangeAircraft2019, bonyMeasuringAreaAveragedVertical2019, georgeJOANNEJointDropsonde2021}.  
The instrumentation on HALO was designed to resemble that on EarthCARE, and its calibration and validation were central components of the campaign. 
This is described in detail by Groß et al. (in review). 
The observations also provide a benchmark for limited-area and global storm-resolving models \citep[e.g.,][]{Klocke2017a, satohGlobalCloudResolvingModels2019, fievetTropicalConvectionStormresolving2026}.
...
The PERCUSION campaign aimed not only at quantifying the effects of mesoscale structures, but also at improving our understanding of the processes that drive it. Tropical convection has long been known to be organised by large-scale disturbances such as equatorial waves \citep[e.g.,][]{kiladisConvectivelyCoupledEquatorial2009} and the Madden–Julian Oscillation \citep{maddenDetection4050Day1971, maddenDescriptionGlobalScaleCirculation1972}. In addition to these large-scale drivers, mechanisms acting on smaller scales may also contribute to the organisation of convection. Idealised simulations show that initially randomly distributed clouds can spontaneously aggregate even in homogeneous environments \citep{Held1993, Bretherton2005}. Depending on the model configuration and the stage of aggregation, a variety of feedbacks have been proposed to drive this behaviour, including convection–humidity feedbacks mediated by detrainment, cloud–radiative feedbacks, and radiatively driven circulations that transport humidity up-gradient \citep[e.g.,][]{Wing2017}. 
Other processes have been argued to drive enhanced convection at the edges of the deep tropics \citep{masunagaEdgeIntensificationEastern2023, windmillerConvectionEdge2019} or to modify regional cloud formation in the presence of the Saharan Air Layer \citep{lauGCMStudyResponse2009}. 
Assessing the relative importance of these mechanisms in Earth's atmosphere remains an open challenge \citep{Bony2015, mullerSpontaneousAggregationConvective2022}.
...
Describe the overall measurement strategy and how that addresses the question of mesoscale structures and processes. 
\begin{itemize} 
...
HERE is where you can find the data: IPFS.
