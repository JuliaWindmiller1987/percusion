...
\begin{itemize}
    \item Figure B: Show that this successfully captures the transition between subsiding / dry / high OLR and ascending / moist / low OLR region (would be nice to include aerosol or humidity plot from WALRES in here!).
\end{itemize}
