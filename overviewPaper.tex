...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figures/250612_Halo_Orcestra.pdf}
    \caption{Updated cloud-observatory configuration as used during PERCUSION \textbf{TODO: fix BACARDI typo.}}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{figures/generic_flight_track.pdf}
    \caption{Example flight (flight ID HALO-20240811a) to illustrate the generic flight pattern. Flight track is shown in organge. GOES satellite image in the background. Column water vapour measurements from Advanced Microwave Scanning Radiometer (AMSR).}
...
\begin{figure}
\centering
\includegraphics[width=0.75\linewidth]{figures/mseDynamics.png}
