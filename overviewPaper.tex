...
\begin{figure}
    ...
    \caption{ITCZ in column water vapour space. (left) cloud occurrence frequency from HAMP activ, IWP from HAMP passiv and longwave radiation from BACARDI, (right) vertical velocity from dropsondes.}
    \label{fig:itcz_cwv}
\end{figure}
