...
\begin{abstract}
%% TODO: abstract still to be written.
\end{abstract}
...
Despite the small circle radius, 60~km rather than 130~km, CWV varies between a minimum value of 46.9~mm in the northern part of the circle and a maximum value of 58.6~mm in the southern part of the circle.
While sharp gradient in CWV are often marked by deep convection, we here show an example where convective activity was limited to a height of about 2 km. In addition to the cloud field, Fig.~\ref{fig:weak_winds_flight_west} shows the vertical distribution of aerosols whose interaction with clouds is a key focus of PERCUSION.
...
Figure~\ref{fig:deep_conv_itcz}b shows the area mean vertical velocity calculated from the dropsondes. Air within this circle is, on average, ascending. Mean CWV for this circle is high: 59.61 $kg/m^2$
