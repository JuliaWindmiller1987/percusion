...
We started using the peer-to-peer nature for on-site data sharing during the field campaign, and continue using it to avoid single point of failures on the server side
